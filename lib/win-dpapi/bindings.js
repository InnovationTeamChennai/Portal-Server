...
* www.icumed.com
* ========================================================================================
* File Name: bindings.js
*
* DESCRIPTION
* This code contains library functions/methods which was using to encrypt and decrypt by "dpapi"
*
*
* ========================================================================================
*/
...
var errCodeModuleNotFound='MODULE_NOT_FOUND';
var errCodeResolutionFailed='QUALIFIED_PATH_RESOLUTION_FAILED'
var fs = require('fs'),
  path = require('path'),
  ...
  defaults = {
    ...
    try: [
	  ...
	  ['module_root','lib','win-dpapi','bindings']
    ]
  };
...
function bindings(opts) {
  ...
  for (; i < l; i++) {
    ...
    try {
      ...
      if (e.code !== errCodeModuleNotFound &&
          e.code !== errCodeResolutionFailed &&
  ...
  err = new Error(
    STATUS.COMMON_MSGS.COULD_NOT_LOCATE_BINDING_FILE+'\n' +
      tries
        .map(function(a) {
          return opts.arrow + a;
        })
...
exports.getRoot = function getRoot(file) {
  ...
  while (true) {
    ...
    if (prev === dir) {
      // Got to the top
      throw new Error(
        STATUS.COMMON_MSGS.COULD_NT_FIND_MODULE+' "' +
          file +
          STATUS.COMMON_MSGS.PACKAGE_JSON_NOT_FOUND
      );
    }
